...
#define ETH_MACCR_BL                                                                               \
    ((uint32_t)0x00000060) /* Back-off limit: random integer number (r) of slot time delays before \
...
#define ETH_MACFFR_PCF_ForwardAll                                                                  \
    ((uint32_t)0x00000080) /* MAC forwards all control frames to application even if they fail the \
                              Address Filter */
...
#define ETH_MACA1HR_MBC                                                                            \
    ((uint32_t)0x3F000000) /* Mask byte control: bits to mask for comparison of the MAC Address    \
                              bytes */
...
#define ETH_MMCRIR_RGUFS                                                                           \
    ((uint32_t)0x00020000) /* Set when Rx good unicast frames counter reaches half the maximum     \
                              value */
...
#define ETH_MMCRIMR_RGUFM                                                                          \
    ((uint32_t)0x00020000) /* Mask the interrupt when Rx good unicast frames counter reaches half  \
                              the maximum value */
#define ETH_MMCRIMR_RFAEM                                                                          \
    ((uint32_t)0x00000040) /* Mask the interrupt when when Rx alignment error counter reaches half \
                              the maximum value */
#define ETH_MMCRIMR_RFCEM                                                                          \
    ((uint32_t)0x00000020) /* Mask the interrupt when Rx crc error counter reaches half the        \
                              maximum value */

/* Bit definition for Ethernet MMC Transmit Interrupt Mask Register */
#define ETH_MMCTIMR_TGFM                                                                           \
    ((uint32_t)0x00200000) /* Mask the interrupt when Tx good frame count counter reaches half the \
                              maximum value */
#define ETH_MMCTIMR_TGFMSCM                                                                        \
    ((uint32_t)0x00008000) /* Mask the interrupt when Tx good multi col counter reaches half the   \
                              maximum value */
#define ETH_MMCTIMR_TGFSCM                                                                         \
    ((uint32_t)0x00004000) /* Mask the interrupt when Tx good single col counter reaches half the  \
                              maximum value */

/* Bit definition for Ethernet MMC Transmitted Good Frames after Single Collision Counter Register
 */
#define ETH_MMCTGFSCCR_TGFSCC                                                                      \
    ((uint32_t)0xFFFFFFFF) /* Number of successfully transmitted frames after a single collision   \
                              in Half-duplex mode. */

/* Bit definition for Ethernet MMC Transmitted Good Frames after More than a Single Collision
 * Counter Register */
#define ETH_MMCTGFMSCCR_TGFMSCC                                                                    \
    ((uint32_t)0xFFFFFFFF) /* Number of successfully transmitted frames after more than a single   \
...
#define ETH_DMABMR_RDP_1Beat                                                                       \
    ((uint32_t)0x00020000) /* maximum number of beats to be transferred in one RxDMA transaction   \
                              is 1 */
#define ETH_DMABMR_RDP_2Beat                                                                       \
    ((uint32_t)0x00040000) /* maximum number of beats to be transferred in one RxDMA transaction   \
                              is 2 */
#define ETH_DMABMR_RDP_4Beat                                                                       \
    ((uint32_t)0x00080000) /* maximum number of beats to be transferred in one RxDMA transaction   \
                              is 4 */
#define ETH_DMABMR_RDP_8Beat                                                                       \
    ((uint32_t)0x00100000) /* maximum number of beats to be transferred in one RxDMA transaction   \
                              is 8 */
#define ETH_DMABMR_RDP_16Beat                                                                      \
    ((uint32_t)0x00200000) /* maximum number of beats to be transferred in one RxDMA transaction   \
                              is 16 */
#define ETH_DMABMR_RDP_32Beat                                                                      \
    ((uint32_t)0x00400000) /* maximum number of beats to be transferred in one RxDMA transaction   \
                              is 32 */
#define ETH_DMABMR_RDP_4xPBL_4Beat                                                                 \
    ((uint32_t)0x01020000) /* maximum number of beats to be transferred in one RxDMA transaction   \
                              is 4 */
#define ETH_DMABMR_RDP_4xPBL_8Beat                                                                 \
    ((uint32_t)0x01040000) /* maximum number of beats to be transferred in one RxDMA transaction   \
                              is 8 */
#define ETH_DMABMR_RDP_4xPBL_16Beat                                                                \
    ((uint32_t)0x01080000) /* maximum number of beats to be transferred in one RxDMA transaction   \
                              is 16 */
#define ETH_DMABMR_RDP_4xPBL_32Beat                                                                \
    ((uint32_t)0x01100000) /* maximum number of beats to be transferred in one RxDMA transaction   \
                              is 32 */
#define ETH_DMABMR_RDP_4xPBL_64Beat                                                                \
    ((uint32_t)0x01200000) /* maximum number of beats to be transferred in one RxDMA transaction   \
                              is 64 */
#define ETH_DMABMR_RDP_4xPBL_128Beat                                                               \
    ((uint32_t)0x01400000) /* maximum number of beats to be transferred in one RxDMA transaction   \
                              is 128 */
...
#define ETH_DMABMR_PBL_1Beat                                                                       \
    ((uint32_t)0x00000100) /* maximum number of beats to be transferred in one TxDMA (or both)     \
                              transaction is 1 */
#define ETH_DMABMR_PBL_2Beat                                                                       \
    ((uint32_t)0x00000200) /* maximum number of beats to be transferred in one TxDMA (or both)     \
                              transaction is 2 */
#define ETH_DMABMR_PBL_4Beat                                                                       \
    ((uint32_t)0x00000400) /* maximum number of beats to be transferred in one TxDMA (or both)     \
                              transaction is 4 */
#define ETH_DMABMR_PBL_8Beat                                                                       \
    ((uint32_t)0x00000800) /* maximum number of beats to be transferred in one TxDMA (or both)     \
                              transaction is 8 */
#define ETH_DMABMR_PBL_16Beat                                                                      \
    ((uint32_t)0x00001000) /* maximum number of beats to be transferred in one TxDMA (or both)     \
                              transaction is 16 */
#define ETH_DMABMR_PBL_32Beat                                                                      \
    ((uint32_t)0x00002000) /* maximum number of beats to be transferred in one TxDMA (or both)     \
                              transaction is 32 */
#define ETH_DMABMR_PBL_4xPBL_4Beat                                                                 \
    ((uint32_t)0x01000100) /* maximum number of beats to be transferred in one TxDMA (or both)     \
                              transaction is 4 */
#define ETH_DMABMR_PBL_4xPBL_8Beat                                                                 \
    ((uint32_t)0x01000200) /* maximum number of beats to be transferred in one TxDMA (or both)     \
                              transaction is 8 */
#define ETH_DMABMR_PBL_4xPBL_16Beat                                                                \
    ((uint32_t)0x01000400) /* maximum number of beats to be transferred in one TxDMA (or both)     \
                              transaction is 16 */
#define ETH_DMABMR_PBL_4xPBL_32Beat                                                                \
    ((uint32_t)0x01000800) /* maximum number of beats to be transferred in one TxDMA (or both)     \
                              transaction is 32 */
#define ETH_DMABMR_PBL_4xPBL_64Beat                                                                \
    ((uint32_t)0x01001000) /* maximum number of beats to be transferred in one TxDMA (or both)     \
                              transaction is 64 */
#define ETH_DMABMR_PBL_4xPBL_128Beat                                                               \
    ((uint32_t)0x01002000) /* maximum number of beats to be transferred in one TxDMA (or both)     \
                              transaction is 128 */
