 ...
 * @Description: the code belongs to jiejie, please keep the author information and source code according to the
 * license.
 */
...
int platform_mutex_lock_timeout(platform_mutex_t *m, TickType_t timeout)
{
